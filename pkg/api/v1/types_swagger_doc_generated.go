...
var map_PersistentVolumeClaimCondition = map[string]string{
	...
	"type":               "Type is the type of the condition. More info: http://releases.k8s.io/HEAD/docs/user-guide/pod-states.md#pod-conditions",
...
var map_PersistentVolumeClaimStatus = map[string]string{
	...
	"conditions":  "Current service state of claim. More info: http://releases.k8s.io/HEAD/docs/user-guide/pod-states.md#pod-conditions",
}
...
var map_PersistentVolumeStatus = map[string]string{
	...
	"conditions": "Current service state of volume More info: http://releases.k8s.io/HEAD/docs/user-guide/pod-states.md#pod-conditions",
}
