...
type PersistentVolumeSpec struct {
	...
	RecyclePolicy RecyclePolicy `json:"recyclePolicy,omitempty" description:"recyclePolicy is what happens to a volume when released from its claim; one of Recycle, Delete, Retain.  Default is Retain."`
}
