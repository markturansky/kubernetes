...
type CephFSVolumeSource struct {
	...
	Monitors []string `json:"monitors,omitempty" description:"a collection of Ceph monitors"`
	// Optional: User is the rados user name, default is admin
	User string `json:"user,omitempty" description:"rados user name; default is admin; optional"`
	// Optional: SecretFile is the path to key ring for User, default is /etc/ceph/user.secret
	SecretFile string `json:"secretFile,omitempty" description:"secretFile is the path to secret for rados user; default is /etc/ceph/user.secret; optional"`
