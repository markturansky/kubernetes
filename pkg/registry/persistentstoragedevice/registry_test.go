...
func NewTestPersistentStorageDeviceEtcdRegistry(t *testing.T) (*tools.FakeEtcdClient, generic.Registry) {
...
func TestPersistentStorageDeviceCreate(t *testing.T) {
	storageDeviceA := &api.PersistentStorageDevice{
		ObjectMeta: api.ObjectMeta{Name: "foo", Namespace: api.NamespaceDefault},
	}

	storageDeviceB := &api.PersistentStorageDevice{
		ObjectMeta: api.ObjectMeta{Name: "foo", Namespace: api.NamespaceDefault},
	}
	...
	for name, item := range table {
		fakeClient, registry := NewTestPersistentStorageDeviceEtcdRegistry(t)
