...
func (s *CMServer) Run(_ []string) error {
	...
	pvController, err := volumeclaimbinder.NewPersistentVolumeController(volumeclaimbinder.NewControllerClient(kubeClient), s.PVClaimBinderSyncPeriod, app.ProbeRecyclableVolumePlugins(s.VolumeConfigFlags), app.NewVolumeProvisionersForCloud(cloud), cloud)
	if err != nil {
