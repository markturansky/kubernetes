...
```
      ...
      --storage-class=[]: List of experimental quality-of-service classes and their provisioners.  Values are QoSName/volume-plugin-name.
...
###### Auto generated by spf13/cobra on 20-Nov-2015
